...
```answer2-2
    ...
    в versions.tf, авторизация при помозе статичного ключа созданного
...
Настроены все upstream для вышеуказанных URL, куда они сейчас ведут на этом шаге не важно, позже вы их отредактируете и укажите верные значения.
